...
$(function()
{
    $('form[name="loginform"] input[type="submit"]').click(function(event)
    {
        ...
        if($(this).val()=='Login')
        {
            ...
            //$form.attr('onSubmit', "document.getElementById('hashedpassword').value=hex_sha256 (document.getElementById('password').value + document.getElementById('hash').value); ")
			//$form.attr('onSubmit', "document.getElementById('password').value=hex_sha256 (document.getElementById('password').value + document.getElementById('hash').value); ")
        }
        else
        {
